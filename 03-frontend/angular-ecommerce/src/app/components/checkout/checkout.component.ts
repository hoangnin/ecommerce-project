...
export class CheckoutComponent implements OnInit {
  ...
  */
  ...
  for (let i=0; i<cartItems.length, i++){
    ...
    // - short way ò doing the same thing
          ...
          this.stripe.confirmCardPayment(paymentIntentResponse.client_secret,
            ...
            .then((result: any) => {
              if (result.error) {
                ...
                alert(`There was an erroe: ${result.error.message}`)
  ...
  resetCart() {
    ...
    this.cartService.persistCartItems(); // when checkout finish, then we reload page, the cart is not rezo, so we call this method to stoge again 
    // reset the form
